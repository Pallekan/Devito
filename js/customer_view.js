 ...
 */
        ...
        function onlyPermitIfFilledIn(fun,arg1,arg2)
        {
            ...
            {
                document.getElementById("errorNotice").innerHTML = "Ogiltig avrese-plats. V�nligen skriv in en giltig upplockningsplats.";
                return;
            }
            if(document.getElementById('orderInfoTo').value == "")
            {
                document.getElementById("errorNotice").innerHTML = "Ogiltig destination. V�nligen skriv in en giltig destination.";
                return;
            }
            if(document.getElementById('orderInfoCount').value == "" || document.getElementById("orderInfoCount").value < 1)
            {
                document.getElementById("errorNotice").innerHTML = "Ogiltigt antal. V�nligen skriv in ett giltigt antal passagerare.";
                return;
            }
            ...
            {
                document.getElementById("errorNotice").innerHTML = "Ogiltig tid. V�nligen skriv in en giltig upplockningstid.";
                return;
            }
            fun(arg1,arg2);
        }
        ...
        function avbrytResa()
        {
            if (confirm("�r du s�ker p� att du vill avboka din resa? Du kan inte beh�lla din v�ntade tid"))
            {
                fillTimeField("orderHourOptions","Timma","makeHourOptions",23,1);
                fillTimeField("orderMinuteOptions","Minut","makeMinuteOptions",59,5);

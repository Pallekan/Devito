...
app.get('/', function (req, res) {
  res.sendFile(path.join(__dirname, 'Customer/html/customer_view.html'));
});
// Serve driver.html as /driver
app.get('/driver', function (req, res) {
  res.sendFile(path.join(__dirname, 'Customer/html/driver_view.html'));
});
// Serve dispatcher.html as /dispatcher
app.get('/dispatcher', function (req, res) {
  res.sendFile(path.join(__dirname, 'Customer/html/manager_view.html'));
});
